...
export const ScreenConfigTable = pgTable('screenConfig', {
  ...
  code: text(),
})   // Stores high-level project metadata + AI-generated design system info
// projectId is unique because ScreenConfig references it as a foreign key
// Stores per-screen layout configuration generated by AI
// Each screen belongs to one project via projectId
